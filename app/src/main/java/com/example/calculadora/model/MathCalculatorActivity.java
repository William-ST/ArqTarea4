...
public class MathCalculatorActivity extends AppCompatActivity implements
    ...
    private void initializeViewComponents() {
        ...
        buttons = Arrays.asList((Button) findViewById(R.id.bt_parenthesis_start),
                (Button) findViewById(R.id.bt_parenthesis_end),
                (Button) findViewById(R.id.bt_parenthesis_end),
                (Button) findViewById(R.id.bt_subtraction),
                (Button) findViewById(R.id.bt_multiplication),
                (Button) findViewById(R.id.bt_division),
                (Button) findViewById(R.id.bt_exponentiation),
                (Button) findViewById(R.id.bt_square_root),
                (Button) findViewById(R.id.bt_factorial),
                (Button) findViewById(R.id.bt0),
                (Button) findViewById(R.id.bt00),
                (Button) findViewById(R.id.bt1),
                (Button) findViewById(R.id.bt2),
                (Button) findViewById(R.id.bt3),
                (Button) findViewById(R.id.bt4),
                (Button) findViewById(R.id.bt5),
                (Button) findViewById(R.id.bt6),
                (Button) findViewById(R.id.bt7),
                (Button) findViewById(R.id.bt8),
                (Button) findViewById(R.id.bt9),
